...
const CommanderLIV = ({ navigation }: any) => {
    ...
    const goToSuggestionChauffeur = () => {
       // navigation.navigate('SuggestionChauffeur', { driverType: selectionner });  // Passer le type de conducteur sélectionné
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.overlay}>
                ...
                <TouchableOpacity
                    onPress={goToSuggestionChauffeur}
